...
import { open, selectFooter } from "../redux/FooterSlice";
import PrivacyPolicy from "../components/PrivacyPolicy";
import TermsAndConditions from "../components/TermsAndConditions";
import freelancerAuthService from "../service/FreelancerAuthService";
...
const Signup = () => {
  ...
  const handleSubmitFreelance = (e) => {
    ...
    freelancerAuthService.SignUp({
      firstname: firstname,
      lastname: lastname,
      password: passwordfreelancer,
  ...
  return (
    <div>
      <div
        className={`${
          viewFooter?.viewPrivacyPolicy === "true" ? "block" : "hidden"
        }`}
      >
        <PrivacyPolicy />
      </div>
      <div
        className={`${
          viewFooter?.viewTermsandConditions === "true" ? "block" : "hidden"
        }`}
      >
        <TermsAndConditions />
      </div>
              ...
              <form onSubmit={handleSubmitFreelance} className="mt-8">
                ...
                <div className="flex">
                  ...
                  <p>
                    ...
                    <span
                      className="underline tracking-wider cursor-pointer text-blue"
                      onClick={() =>
                        dispatch(open({ viewTermsandConditions: "true" }))
                      }
                    >
                      terms of service
                    </span>{" "}
